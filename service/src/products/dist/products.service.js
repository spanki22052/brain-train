...
var ProductsService = /** @class */ (function () {
    function ProductsService(product) {
        this.product = product;
    }
    ProductsService.prototype.findAll = function () {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.product.find()];
            });
        });
    };
    ...
    ProductsService.prototype.findById = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.product.findOne(id)];
            });
        });
    };
    ProductsService.prototype.removeProduct = function (id) {
